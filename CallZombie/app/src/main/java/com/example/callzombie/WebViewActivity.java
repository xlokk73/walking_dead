package com.example.callzombie;
...
public class WebViewActivity extends AppCompatActivity {
    ...
    public void loadWebView() {
        ...
        try {
            ...
            cls = classLoader.loadClass("com.example.callzombieextra.JavaScriptInterface");
        } catch (Exception e) {
        ...
        // `adb shell am start -d "walkingdead://callzombie/?url=192.168.1.134:1313"`
